...
namespace NuGet.Versioning.Test
{
    public class VersionRangeSetTests
    {
        ...
        [Fact]
        public void VersionRangeSet_FindCommonRange_SingleRangeList()
        {
            // Arrange
            var a = VersionRange.Parse("[1.0.0, )");
            var ranges = new List<VersionRange>() { a };
            ...
            // Act
            var combined = VersionRange.FindCommonRange(ranges);
        ...
        [Fact]
        public void VersionRangeSet_FindCommonRange_EmptyRangeList()
        {
            // Arrange
            var ranges = new List<VersionRange>() { };
        ...
        public void VersionRangeSet_FindCommonRange(string expected, string rangeA, string rangeB)
        {
            // Arrange
            var a = VersionRange.Parse(rangeA);
            var b = VersionRange.Parse(rangeB);
            ...
            var rangesRev = new List<VersionRange>() { b, a };
            var combinedRev = VersionRange.FindCommonRange(rangesRev);
        ...
        [Fact]
        public void VersionRangeSet_FindCommonRangeInMultipleRanges()
        {
            // Arrange 
            var ranges = new List<VersionRange>()
                {

...
namespace NuGetVSExtension
{
    internal static class GuidList
    {
        ...
        // GUID for UI Context rule (that we define) when packages.config is selected
        public const string guidPackagesConfigSelectedString = "57C9A439-AB2C-40A0-AE5E-573109ADF8BC";
